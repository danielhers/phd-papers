...
Supplementary Material for elaborate results.}
...
important\oa{give one or two numbers here. what are the F-score differences?},
...
We have introduced the first grammarless parser that supports multiple parents, non-terminal
nodes and discontinuous units.
We further explore a conversion-based parsing approach to assess the ability of existing
technology to address the task, and make an additional contribution by first experimenting on UCCA parsing.
