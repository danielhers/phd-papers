...
While some grammar-based parsers,
such as HPSG- or DRT-based approaches, can be said to support the BSS
criteria, they address somewhat different challenges, as they map into
ungrounded representations by relying on elaborate theories of the
syntax-semantics interface, while we map into grounded
representations, taking a transition-based approach that makes
considerably less theoretical commitments.
