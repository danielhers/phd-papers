...
inter-annotator agreement, given UCCA’s inter-annotator agreement of 80--85\%
...
defined by the $h^*$ function (Appendix~\ref{appendix:conversion}).
...
\caption[]{\label{fig:features}
  ...
  (Appendix~\ref{appendix:conversion}).\\
