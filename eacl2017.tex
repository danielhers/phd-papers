...
We refer to the neural network-based parser as \parser{}(NN).\footnote{A link to the code repository will be released upon publication.}
...
For the dense perceptron-based (\parser{}(dense)) and the neural network-based parser (\parser{}(NN)),
