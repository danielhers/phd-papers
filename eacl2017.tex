...
In order for an anchored\footnote{By \textit{anchored} we mean the text tokens are
anchored in the words and phrases of the text.}
semantic representation to cover the full range of semantic
...
which to our knowledge are the only corpora annotated with anchored semantic
...
\daniel{joint syntactic/semantic parsing:
Henderson et. al., 2013 and Swayamdipta et. al., 2016}
...
\daniel{LSTM DAG parser: Zhu et. al., NAACL 2016}
...
% FEATURES
\daniel{Move to supplementary material}
\begin{figure}
...
and passages 701--965 as in-domain test set.
