...
HAR18: \citet{hershcovich2018multitask}.}\label{tab:aux_results}
\end{table}
...
\end{tabular}
\caption{
Fine-grained evaluation according to UCCA categories.}
...
\end{tabular}
\caption{
Fine-grained evaluation according to UD relations.}
