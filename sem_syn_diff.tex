...
\item Formal annotation choices,
\item Content.
\end{itemize}
...
The \texttt{head} edges are introduced as part of the conversion do not have a single
...
To overcome this limitation, we replace all \texttt{head} labels with C, but then
...
it is much more common (14719 P's in the Wiki corpus as opposed to 3354 S's).
  ...
  child {node (1_2) [circle] {}
    ...
    child {node (1_5) [circle] {}
      ...
      child {node (1_7) [circle] {}
        ...
        child {node (1_9) [word] {billion} edge from parent node[auto] {\scriptsize $C$}} }edge from parent node[auto] {\scriptsize $C$}} }edge from parent node[auto] {\scriptsize $A$}} }edge from parent node[above] {\scriptsize $H$}}
  child {node (1_10) [circle] {}
    {
