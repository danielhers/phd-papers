...
\maketitle
\begin{abstract}
The paper presents our experiments with applying TUPA to the CoNLL 2018 UD shared task. TUPA is a general neural transition-based DAG parser, which we use to present the first experiments on recovering enhanced dependencies as part of the general parsing task. TUPA was designed for parsing UCCA, a cross-linguistic semantic annotation scheme, exhibiting reentrancy, discontinuity and non-terminal nodes. By converting UD trees and graphs to a UCCA-like DAG format, we train TUPA almost without modification on the UD parsing task. The generic nature of our approach lends itself naturally to multitask learning.  
...
We focus only on parsing, using a baseline model \cite[UDPipe 1.2;][]{udpipe,udpipe:2017}\oa{{\bf the} baseline model?}
...
get an acyclic graph.\oa{how often does that happen?}
...
Unless otherwise noted, we use the default values provided by the package.\oa{it's good to write down DyNet's version in this case}
...
by 2.84 LAS-F1 points on the test set,
...
%Re-trained & 71.98 & 71.91 & 54.94 & 56.21\\
$-$NER & 71.72 & 71.67 & 55.56 & 54.86\\
$-$POS & 69.14 & 69.41 & 54.21 & 49.42\\
$-$Embed. & 72.23 & 72.42 & 56.47 & 54.82\\
