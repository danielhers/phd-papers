...
This yielded an unofficial average test LAS~$F_1$ of 61.05,
an improvement of 7.36 points over the official average score.
...
we evaluate them separately using our own evaluation
script\footnote{\url{https://github.com/danielhers/semstr/blob/master/semstr/evaluate.py}}.
...
However, TUPA learns them successfully, getting as much as 60.7 enhanced LAS $F_1$
on the English EWT test set.
...
\hline
% rubbish, should use my modified conll18_ud_eval.py instead of evaluate.py
...
\hline
% rubbish... this is evaluated vs. udpipe, not vs. gold
%\small original          & 74.3 & 74.9 & 26.9 & 25.1 \\
%\small fixed             & 76.9 & 77.3 & 27.3 & 26.3 \\
%\small no ner            & 76.6 & 76.7 & 26.5 & 26   \\
%\small no ner, no remote & 76.8 & 76.9 & 0    & 0    \\
%\small no pos            & 70.6 & 70.8 & 24   & 24.7 \\
%\small no w2v            & 77.3 & 77.6 & 25.9 & 25.8 \\
%\small no w2v, no remote & 77.2 & 77.7 & 0    & 0    \\
%\small no remote         & 76.9 & 77.4 & 0    & 0
\end{tabular}
