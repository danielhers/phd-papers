...
\begin{figure*}[h]
    ...
    bar width=4pt,
    xtick=data,
    xticklabels from table={udst2018scores.txt}{corpusa},
    ...
    \addplot [select coords between index={0}{26}] table[x expr=\coordindex,meta=corpus,y=tupa]{udst2018scores.txt};
    \addplot [select coords between index={0}{26}] table[x expr=\coordindex,meta=corpus,y=tupadev]{udst2018scores.txt};
    ...
    bar width=4pt,
    xtick=data,
    xticklabels from table={udst2018scores.txt}{corpusb},
    xticklabel style={font=\tiny,rotate=90,anchor=east},
    xtick align=inside,
    xticklabel pos=left,
    tickwidth=0pt,
    ...
    \addplot [select coords between index={27}{53}] table[x expr=\coordindex,meta=corpus,y=tupa]{udst2018scores.txt};
    \addplot [select coords between index={27}{53}] table[x expr=\coordindex,meta=corpus,y=tupadev]{udst2018scores.txt};
    \end{axis}
    \end{tikzpicture}
    ...
    bar width=4pt,
    xtick=data,
    xticklabels from table={udst2018scores.txt}{corpusc},
    xticklabel style={font=\tiny,rotate=90,anchor=east},
    xtick align=inside,
    xticklabel pos=left,
    tickwidth=0pt,
    ...
    \addplot [select coords between index={54}{81}] table[x expr=\coordindex,meta=corpus,y=tupa]{udst2018scores.txt};
    \addplot [select coords between index={54}{81}] table[x expr=\coordindex,meta=corpus,y=tupadev]{udst2018scores.txt};
    \end{axis}
    \end{tikzpicture}
