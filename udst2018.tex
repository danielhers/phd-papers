...
\begin{figure*}[h]
    ...
    \addplot [select coords between index={0}{27}] table[x expr=\coordindex,meta=corpus,y=official]{udst2018scores.txt};
    \addplot [select coords between index={0}{27}] table[x expr=\coordindex,meta=corpus,y=test]{udst2018scores.txt};
    \addplot [select coords between index={0}{27}] table[x expr=\coordindex,meta=corpus,y=dev]{udst2018scores.txt};
    \legend{TUPA (dev), TUPA (test--unofficial), TUPA (test--official)}
    \end{axis}
    \end{tikzpicture}
    ...
    \addplot [select coords between index={28}{54}] table[x expr=\coordindex,meta=corpus,y=official]{udst2018scores.txt};
    \addplot [select coords between index={28}{54}] table[x expr=\coordindex,meta=corpus,y=test]{udst2018scores.txt};
    \addplot [select coords between index={28}{54}] table[x expr=\coordindex,meta=corpus,y=dev]{udst2018scores.txt};
    \end{axis}
    \end{tikzpicture}
    ...
    \addplot [select coords between index={55}{81}] table[x expr=\coordindex,meta=corpus,y=official]{udst2018scores.txt};
    \addplot [select coords between index={55}{81}] table[x expr=\coordindex,meta=corpus,y=test]{udst2018scores.txt};
    \addplot [select coords between index={55}{81}] table[x expr=\coordindex,meta=corpus,y=dev]{udst2018scores.txt};
    \end{axis}
    \end{tikzpicture}
