...
\fbox{\begin{subfigure}{0.47\textwidth}
  ...
  \scalebox{.95}{
    \begin{tikzpicture}[sibling distance=14mm, ->,
        ...
        level 2/.style={level distance=9mm},
      ...
      \node (ROOT) [circle] {}
        ...
        child {node (feelverywelcome) [circle] {}
        {
          ...
          child {node (verywelcome) [circle] {}
          {
            child {node [word] {very} edge from parent node[midway,below,sloped] {\scriptsize advmod}}
      ...
      ;
      \draw[dashed,->,bend left=36] (verywelcome) to node [midway,below,sloped] {\scriptsize nsubj} (We);
      \draw[dashed,->,bend right=90] (feelverywelcome) to node [midway,above,sloped] {\scriptsize nsubj} (We);
    \end{tikzpicture}}
...
provide richer information to downstream applications,
