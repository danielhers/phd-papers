...
\author{Daniel Hershcovich$^{1,2}$ \hspace{-3cm} \\
  \and
  Omri Abend$^2$ \\
...
\section{Introduction}\label{sec:introduction}
  ...
  their ability to transparently reflect distinctions relevant for text understanding. For example, syntactic representations
  are usually sensitive to distinctions based on POS (part of speech), e.g., between compounds
  ...
  (e.g., ``US president''/``president of the US''),
...
%  where a syntactic scheme would not.
  ...
  play in semantic parsing, if any \citep{swayamdipta2018syntactic,strubell2018linguistically,P18-1192,C18-1233}.
  ...
  Universal Dependencies \citep[UD; ][]{nivre2016universal}
  and Universal Conceptual Cognitive Annotation \citep[UCCA; ][]{abend2013universal}.
  ...
  We align their nodes, and identify which UCCA categories match which UD relations,
  ...
  UCCA parsing in particular and semantic parsing in general will likely benefit
  ...
  significant content overlap \citep{abend2017state}.
...
\section{Representations}\label{sec:representations}
  ...
  This section provides a brief introduction to each of the schemes, whereas
...
%\citep[UD; ][]{nivre2016universal} is
...
%  unlike other dependency schemes that prefer functional ones.
  ...
  Lexical head schemes are more similar in form to semantic schemes,
...
English Web Treebank \citep[EWT; ][]{bies2012english}.
...
English\_EWT treebank, this is a \textit{shared} gold-standard UCCA/UD
annotated corpus.
...
We match pairs of nodes in the converted UD and UCCA trees
...
intermediate non-terminals and \textit{head} edges introduced by the converter.
...
\citep{SCHUSTER16.779}, which form (bi-lexical) graphs, representing phenomena
such as predicate ellipsis (e.g., gapping),
and shared arguments due to coordination, control, raising and relative clauses.

UCCA is more inclusive in its use of remote edges, accounting for 
...
\textit{create}. 
Another example: ``if you call for an appointment [...] you can then make one''.
A remote edge indicates that \textit{one} refers to \textit{appointment}.
...
\hline
\bf \tt acl & 8 &&& 101 & 2 && 15 &&&&&& 1 && 49 \\
\bf \tt advcl & 2 & 2 &&&&& 103 & 1 && 4 &&&&& 97 \\
\bf \tt advmod & 61 & 9 & 399 & 51 & 12 & 33 & 3 & 61 && 2 & 10 & 6 & 5 & 117 & 71 \\
\bf \tt amod & 1 & 33 & 99 & 197 & 2 && 7 &&& 3 & 27 && 97 & 2 & 60 \\
\bf \tt appos & 1 & 10 && 8 &&& 5 &&&& 1 && 4 && 10 \\
\bf \tt aux &&& 96 && 285 &&&&&&&&&& 2 \\
\bf \tt case & 1 & 5 & 2 & 14 & 34 &&& 48 & 6 & 1 & 1 & 489 & 50 && 75 \\
\bf \tt cc &&& 1 &&&&& 305 & 71 && 1 & 1 &&& 11 \\
\bf \tt ccomp & 78 &&&&&& 8 &&&&&& 1 && 41 \\
\bf \tt compound & 23 & 24 & 8 & 176 & 2 &&&&& 1 & 1 & 1 & 3 & 3 & 164 \\
\bf \tt conj & 2 & 88 & 1 &&&& 265 &&& 2 &&& 3 && 90 \\
\bf \tt cop &&&&& 333 &&&&& 3 && 1 & 24 && 3 \\
\bf \tt csubj & 2 &&&&&&&&&&&&&& 8 \\
\bf \tt dep &&&&&&&&&&&& 1 &&&\\
\bf \tt det & 2 & 1 & 19 & 763 & 1 & 1 &&&&& 19 & 2 &&& 26 \\
\bf \tt discourse && 1 &&& 1 & 6 & 13 & 3 &&&&& 1 && 1 \\
\bf \tt expl &&&&& 22 &&&&&&&&&& 2 \\
\bf \tt iobj & 19 &&&&&&&&&&&&&&\\
\bf \tt list && 2 &&&&& 8 &&&&&&&& 2 \\
\bf \tt mark && 2 & 3 && 186 & 1 && 134 & 1 &&& 53 & 1 & 1 & 18 \\
\bf \tt nmod & 100 & 1 & 1 & 233 &&& 6 &&&&&& 3 & 4 & 110 \\
\bf \tt nsubj & 993 &&&& 14 && 2 & 9 && 3 && 24 & 1 && 37 \\
\bf \tt nummod & 4 & 7 && 6 &&& 3 &&&& 50 &&&& 24 \\
\bf \tt obj & 439 & 7 & 5 & 1 & 1 && 1 & 1 && 8 & 1 & 6 && 4 & 92 \\
\bf \tt obl & 247 & 1 & 21 & 7 & 2 & 4 & 4 & 4 &&& 3 & 2 && 69 & 132 \\
\bf \tt orphan & 1 &&&&&&&&&&&&&& 1 \\
\bf \tt parataxis & 1 &&& 1 && 2 & 79 &&& 1 &&& 2 && 39 \\
\bf \tt vocative & 9 &&&&& 3 &&&&&&&&&\\
\bf \tt xcomp & 44 & 1 & 2 & 2 &&& 1 &&& 5 &&& 7 && 116 \\
\hline
...
If we identify predicates as words having at least one argument
...
\paragraph{Clausal arguments}
    ...
    However, as complements to a secondary verb, they
...
\paragraph{Auxiliary verbs}
    ...
    in UD are treated as clausal heads, taking a clausal complement. 
    For example, in ``able to do well'', UD treats \textit{able} as the head,
    taking \textit{do well} as an \texttt{xcomp}. UCCA, on the other hand,
...
Conversely, compounds are not necessarily unanalyzable in UCCA,
...
\paragraph{Discourse markers and interjections.}
    Units relating a Scene to the speech event or the speaker's opinion are Ground
...
\paragraph{Vocatives}
    ...
    For example, \textit{Mark} in ``Thanks \textit{Mark}'' is both addressed and thanked.\footnote{UCCA allows marking more than one category over an edge, although this
...
%\citep{de2017old,velldal2017joint}.
%
...
%\end{tabular}
%\caption{
%Development scores for TUPA \protect\citep{hershcovich2017a} when trained on increasing amount of training data
%(English Wiki corpus).
...
& \tiny \bf Labeled F1 \% & 92 & 81 & 78 & 70 & 67 & 67 & 63 & 62 & 61 & 60 & 58 & 56 & 51 & 50 & 50 & 41 & 40 & 39 & 34 & 33 & 31 & 29 & 13 & 12 & 12 & 0 & 0 \\
& \tiny \bf Unlabeled F1 \% & 96 & 94 & 97 & 92 & 81 & 98 & 81 & 91 & 96 & 88 & 73 & 82 & 79 & 93 & 59 & 65 & 90 & 53 & 75 & 49 & 56 & 63 & 50 & 55 & 96 & 29 & 67 \\
\hline
\multirow{5}{*}{\footnotesize (b)}
& \tiny \bf Total in UD \# & 834 & 1083 & 383 & 727 & 94 & 364 & 19 & 840 & 400 & 24 & 566 & 458 & 406 & 400 & 128 & 496 & 528 & 176 & 451 & 209 & 178 & 39 & 12 & 125 & 26 & 10 & 12 \\
& \tiny \bf Match Gold \# & 808 & 1046 & 381 & 652 & 70 & 361 & 19 & 769 & 382 & 22 & 474 & 346 & 239 & 388 & 87 & 364 & 467 & 127 & 361 & 112 & 62 & 29 & 12 & 86 & 25 & 2 & 10 \\
& \tiny \bf Match Predicted \# & 778 & 959 & 363 & 680 & 61 & 354 & 13 & 697 & 375 & 21 & 335 & 303 & 238 & 358 & 61 & 234 & 435 & 70 & 265 & 51 & 60 & 19 & 4 & 45 & 25 & 5 & 5 \\
& \tiny \bf Labeled Correct \# & 728 & 815 & 291 & 465 & 44 & 239 & 10 & 454 & 230 & 13 & 233 & 181 & 122 & 187 & 37 & 122 & 180 & 38 & 106 & 27 & 19 & 7 & 1 & 8 & 3 & 0 & 0 \\
& \tiny \bf Unlabeled Correct \# & 759 & 941 & 361 & 616 & 53 & 351 & 13 & 670 & 363 & 19 & 296 & 266 & 188 & 347 & 44 & 194 & 408 & 52 & 234 & 40 & 34 & 15 & 4 & 36 & 24 & 1 & 5 \\
\hline
\multirow{3}{*}{\footnotesize (c)}
& \tiny \bf Labeled/Unlabeled \% & 96 & 87 & 81 & 75 & 83 & 68 & 77 & 68 & 63 & 68 & 79 & 68 & 65 & 54 & 84 & 63 & 44 & 73 & 45 & 68 & 56 & 47 & 25 & 22 & 13 & 0 & 0 \\
& \tiny \bf Majority Gold \% & 96 & 95 & 75 & 75 & 76 & 92 & 100 & 68 & 42 & 100 & 93 & 67 & 73 & 79 & 90 & 68 & 47 & 80 & 73 & 92 & 71 & 34 & 75 & 92 & 52 & 100 & 80 \\
& \tiny \bf Majority Train \% & 98 & 88 & 91 & 90 & 80 & 49 & 90 & 59 & 46 & 87 & 80 & 62 & 82 & 55 & 68 & 61 & 83 & 78 & 58 & 86 & 71 & 53 & 100 & 83 & 31 & 86 & 100 \\
\hline
\footnotesize (d)
& \tiny \bf Average Words \# & 1.0 & 1.6 & 1.0 & 1.0 & 1.2 & 1.0 & 1.1 & 1.2 & 1.0 & 1.0 & 3.1 & 2.4 & 1.2 & 1.0 & 7.4 & 3.8 & 1.2 & 5.1 & 5.3 & 6.0 & 5.8 & 2.9 & 1.6 & 5.7 & 1.0 & 3.3 & 2.0
\end{tabular}
...
(conversion to a shared format and matching units by terminal yield)
...
%For comparability with previous work \citep{hershcovich2017a,hershcovich2018multitask},
%we also perform our experiments on Wiki v1.2.0 \citep{abend2013universal},
%on 20K v1.0.0 in English and French \citep{sulem2015conceptual},
...
%\citep{11234/1-2895}.\footnote{\url{hdl.handle.net/11234/1-2895}}
...
We additionally use UDPipe v1.2 \citep{udpipe,udpipe:2017},
trained on
...
TUPA v1.3 \citep{hershcovich2017a,hershcovich2018multitask},
...
%we use UDPipe v1.2 \citep{udpipe,udpipe:2017}, trained on the UD v2.3 treebanks,
...
%\paragraph{Baselines.}
%
%As a point of comparison, we evaluate TUPA \citep{hershcovich2017a} on the test sets,
...
%We use the converted UD data as ``silver-standard'' data \citep{W17-7306,N18-1104}
...
it correctly categorizes only 87\% of the correctly delineated units,
...
They are mostly Functions, Linkers and Parallel Scenes in EWT,
while the distribution in Wiki is less peaked, with more of the units annotated as
States, Connectors and Centers.
This distinction is between identity and attribution for copulas,
...
but are annotated as Adverbials and Functions).
...
for output space pruning \citep{xue2004calibrating}, 
syntactic features \citep{gildea2002automatic,N15-1007,E17-1045}, 
joint modeling \citep{surdeanu2008conll,hajivc2009conll}, and
multi-task learning \citep{swayamdipta2016greedy,swayamdipta2018syntactic,strubell2018linguistically}.
Some syntactic representation approaches, notably CCG \citep{Steedman:00},
directly reflect the underlying semantics, and have been used to
transduce semantic forms using rule-based systems \citep{Basile:12}.
...
%by achieving strong performance without explicitly modeling syntax \citep{Peng-EtAl:2018:NAACL,P18-2077,P18-1192,C18-1233}.
  
However, empirical study of
the differences between syntactic and semantic schemes is still scarce.
\citet{zhang2017evaluation} evaluated PredPatt \citep{white2016universal},
a framework for extracting predicate-argument structures from UD,
on converted PropBank annotations.
%They evaluated the extracted predicate-argument relations using both
%gold-standard and parsed UD.
\citet{szubert2018structured} proposed a method for aligning AMR and UD subgraphs,
finding that 97\% of AMR edges are evoked by words or syntactic relations.
\citet{damonte-17} refined AMR evaluation by UD labels.
Similarly, our conversion protocol allows fine-grained UCCA parsing evaluation.

A related line of work tackles the transduction of syntactic structures into semantic ones.
\citet{reddy2016transforming} proposed a rule-based method for converting UD
to logical forms. 
...
\citet{stanovsky2016getting} converted Stanford dependency trees into
...
After annotating a portion of EWT with UCCA,
