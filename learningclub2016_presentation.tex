...
\author{\textbf{Daniel Hershcovich}$^{1,2}$ \And Omri Abend$^2$ \And Ari Rappoport$^2$
}
\institute[]{$^1$Edmond and Lily Safra Center for Brain Sciences, Hebrew University of Jerusalem \\
...
\begin{minipage}{.6\linewidth}
  ...
  \captionof{table}{Excluding root node, implicit nodes, and linkage nodes and edges.}
\end{minipage}
...
Our parser supports the structural properties of UCCA.\footnote{
