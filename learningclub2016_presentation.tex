...
\begin{itemize}
 ...
 \pause
 \item Remote edges represent implied relations, support argument sharing.
...
\begin{frame}
\frametitle{Results}
MLP obtains the highest scores in nearly all metrics:
\begin{center}
	\begin{tabular}{l|ccc|ccc}
	& \multicolumn{3}{c|}{Primary} & \multicolumn{3}{c}{Remote} \\
	& \textbf{LP} & \textbf{LR} & \textbf{LF} & \textbf{LP} & \textbf{LR} & \textbf{LF} \\
...
\begin{itemize}
 ...
 \item Loses important information encoded in remote edges.
\end{itemize}
