...
\begin{minipage}{.5\columnwidth}
  ...
  \begin{center}
  \scalebox{.9}{
    \begin{tikzpicture}[level distance=41mm,sibling distance=29mm, -{Latex[length=5mm]}, line width=2pt,
      ...
      \node (ROOT) [circle] {}
        ...
        child {node [word] {feel} edge from parent node[right] {P}}
...
Transition-based parser supporting reentrancy, discontinuity and non-terminal nodes.
