...
discontinuity (non-projectivity) and non-terminal nodes (constituency).
...
\begin{minipage}{.55\columnwidth}
	...
	\node[anchor=west] at (5.5,.45) {made to feel very welcome .};
	\node[fill=cyan, circle] at (18.5,1.4) {}
...
\end{minipage}
\hspace{1pt}
\begin{minipage}{0.02\columnwidth}
    \vspace{5mm}
    \begin{tikzpicture}
...
\begin{minipage}{.4\columnwidth}
	...
	\node[anchor=west] at (3.3,.45) {made to feel very welcome .};
...
The transition classifier is based on a BiLSTM and features of the stack, buffer and current graph:
\begin{center}
\large
