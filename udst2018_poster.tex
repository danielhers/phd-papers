...
\begin{tcolorbox}
We extend \textbf{TUPA}, a general DAG parser
originally designed for UCCA \cite{hershcovich2017a,hershcovich2018multitask}:
...
\large
   ...
   \node[anchor=west] at (0,5) {Parser state};
   ...
   \node[anchor=west] at (-1.3,11.3) {Transition classifier};
...
\begin{minipage}{.538\columnwidth}
	...
	\node[fill=cyan, circle] at (18.5,1.4) {}
	  child {node[font=\scriptsize] {\ttfamily We} edge from parent [red] node[font=\scriptsize\bf\ttfamily,left] {nsubj}};
	...
	\node[anchor=west] at (5,.45) {\ttfamily were made to feel very welcome .};
	\node[fill=cyan, circle] at (18.5,1.4) {}
	  child {node[font=\scriptsize] {\ttfamily We} edge from parent node[font=\scriptsize\bf\ttfamily,left] {nsubj}};
	...
	\node[fill=cyan, circle] at (18.5,1.4) {}
	  child {node[font=\scriptsize] {\ttfamily were} edge from parent node[font=\scriptsize\bf\ttfamily,left] {nsubj}};
	...
	\node[fill=orange, draw=red, circle] at (18.3,1.4) {}
	  child {node[font=\scriptsize] {\ttfamily were} edge from parent [red] node[font=\scriptsize\bf\ttfamily,right] {aux}};
	\node[anchor=west] at (10,-1.2) {\bf\small\textsc{Reduce}};
	\draw[arrows={-[line width=2pt,length=4mm,width=6mm]}] (9,-.6) -- (9,-1.7);
...
\begin{minipage}{.4\columnwidth}
	...
	\node[fill=orange, circle] at (16.2,1.4) {}
	  child {node[font=\scriptsize] {\ttfamily were} edge from parent node[font=\scriptsize\bf\ttfamily,right] {aux}};
   ...
   \node[fill=cyan, circle] at (14.8,1.3) {}   
	...
	\draw[color=gray,dashed,fill=lightgray!20] (0,-4.7) rectangle (18,1.9);
      ...
      \node (ROOT) at (6.8,1.3) [fill=cyan, circle] {}
        child {node (We) [font=\scriptsize\ttfamily] {We} edge from parent node[font=\scriptsize\bf\ttfamily,midway,above,sloped] {\scriptsize nsubj}}
        child {node {}
        {
	        child {node (weremade) [fill=orange, circle] {}
	        {
	          child {node [font=\scriptsize\ttfamily] {were} edge from parent node[font=\scriptsize\bf\ttfamily,midway,above,sloped] {\scriptsize aux}}
	          child {node [font=\scriptsize\ttfamily] {made} edge from parent node[font=\scriptsize\bf\ttfamily,midway,above,sloped] {\scriptsize head}}
	        } edge from parent [draw=none]}
        } edge from parent [draw=none]}
        child {node [font=\scriptsize\ttfamily] {to} edge from parent node[font=\scriptsize\bf\ttfamily,midway,above,sloped] {\scriptsize mark}}
        child {node (feelverywelcome) [fill=blue, circle] {}
        {
          child {node [font=\scriptsize\ttfamily] {feel} edge from parent node[font=\scriptsize\bf\ttfamily,midway,above,sloped] {\scriptsize head}}
          child {node (verywelcome) [fill=green, circle] {}
          {
            child {node [font=\scriptsize\ttfamily] {very} edge from parent node[font=\scriptsize\bf\ttfamily,midway,above,sloped] {\scriptsize advmod}}
            child {node [font=\scriptsize\ttfamily] {welcome} edge from parent node[font=\scriptsize\bf\ttfamily,midway,above,sloped] {\scriptsize head}}
            child {node [font=\scriptsize\ttfamily] {.} edge from parent node[font=\scriptsize\bf\ttfamily,midway,above,sloped] {\scriptsize punct}}
...
\vspace{5mm}
{\color{Indigo}
\textbf{UCCA}: Intuitive, cross-lingual, and modular semantic representation.
    \textit{Primary edges} form a tree. \textit{Remote edges} (dashed) allow reentrancy,
    creating a DAG \cite{abend2013universal}.
...
\begin{minipage}{.55\columnwidth}
  ...
  \scalebox{.9}{
	...
	A: participant \hspace{1cm} F: function \hspace{1cm} D: adverbial
	\hspace{1cm} P: process \hspace{1cm} S: state \hspace{1cm} U: punctuation
	\end{adjustbox}
...
\begin{minipage}{.45\columnwidth}
   ...
   \begin{deptext}[column sep=.5em,ampersand replacement=\^]
    ...
    \end{deptext}
        ...
        \depedge[edge below,dashed,edge unit distance=.85ex,edge end x offset=4pt]{5}{1}{nsubj:xsubj}
        \depedge[edge below,dashed,edge unit distance=1.2ex,edge end x offset=-3pt]{7}{1}{nsubj:xsubj}
...
We convert UD into a format similar to UCCA and supported by TUPA.
