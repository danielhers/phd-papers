...
Some UD treebanks contain enhanced graphs with additional or augmented edges.
...
\begin{minipage}{.5\columnwidth}
	...
	\end{tabular}
	\captionof{table}{Aggregated test LAS-F1.}
\end{minipage}
\hfill
\begin{minipage}{.4\columnwidth}
	\begin{tabular}{lcc}
	& \bf LAS-F1 & \bf Enhanced \\
	& & \bf LAS-F1 \\
	...
	$-$Remote & 72.08 & 0.00\\ 
	\end{tabular}
	\captionof{table}{Ablation on English EWT development set.}
\end{minipage}
...
vi_vtb
    ...
    \end{tikzpicture}
\catcode`\_=8
\captionof{figure}{Unofficial test LAS-F1 and Enhanced LAS-F1 for TUPA.}
