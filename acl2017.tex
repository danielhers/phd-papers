...
\item
Using dense embedding features rather than binary indicators and
...
transition-based semantic dependency parser in SemEval 2014 \cite{oepen2014semeval} and
...
This performance difference between them should therefore be attributed to the classifier.
...
and parsing jointly.
Our parser does not require separately aligning the input tokens to the graph,
