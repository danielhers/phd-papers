...
words, POS tags, edge labels, punctuation, gap type and parser actions.
...
which we extract by rules on the UCCA structure, POS tags and dependency parse\footnote{
