...
\begin{figure}
	...
	\vspace{5mm}
	\begin{tikzpicture}[->]
	\node[anchor=west] at (1,2.5) {Action classifier};
	\tiny
	\tikzstyle{main}=[circle, minimum size=7mm, draw=black!80, node distance=12mm]
	\foreach \i/\word in {1/{After},2/{graduation},4/{to},5/{Paris},6/{.}} {
    ...
    \node (l3) at (3.5,2.3) {\ldots};
    \node (k3) at (3,3.1) {\ldots};
    \node (i3) at (3.5,.8) {\ldots};
    \node (h3) at (3,0) {\ldots};
    \node (x3) at (\i,-1.5) {\ldots};
