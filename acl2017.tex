...
Top: number of edges corresponding to each construction in the UCCA test corpus.
Bottom: F-score (in percentages) calculated just on these edges, for each parser.}
\end{table*}
