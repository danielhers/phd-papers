...
This paper makes a contribution to this literature by proposing the first grammarless parser that supports multiple parents, non-terminal nodes and discontinuous units, through detailed experiments with different architectures for the local classifier, and comparison to bilexical and tree approximations.
The benefit of this approach is further demonstrated by the identification of
common linguistic constructions, readable from UCCA graphs.
