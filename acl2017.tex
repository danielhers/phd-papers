...
\textsc{uparse} & 60.9 & 61.2 & 6 \\
\hline
\multicolumn{4}{l}{\rule{0pt}{4ex} \footnotesize Dependency Tree Conversion} \\
Upper Bound & 94.6 & 87.8 & 91.1 \vspace{.1cm} \\
MaltParser & 62.8 & 57.7 & 60.2 \\
LSTM & {\bf 73.2} & {\bf 66.9} & {\bf 69.9} \\
\hline
\multicolumn{4}{l}{\rule{0pt}{2ex} \footnotesize Direct Tree Parsing} \\
\parser{sparse} $-$ \textsc{Remote} & \\
\parser{dense} $-$ \textsc{Remote} & \\
\parser{MLP} $-$ \textsc{Remote} & \\
\parser{BiLSTM} $-$ \textsc{Remote} & \\
\end{tabular}
