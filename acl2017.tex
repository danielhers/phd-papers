...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TODO add semantic justification to UCCA
%predicate nouns, adjectives.
%scene is not clause.
%syntactic possessives are sometimes scenes and sometimes semantic possession
%(the destruction of the city).
%remote participants: semantic arguments without syntactic arguments
%cf. AMR about these points
