...
out-of-domain data.\footnote{\scriptsize \url{http://cs.huji.ac.il/~oabend/ucca.html}}
...
\paragraph{Comparison to bilexical tree parsers.}
...
which we extract by rules on the UCCA structure, POS tags and syntactic dependency labels\footnote{
See Appendix~\ref{appendix:constructions} for a listing of the rules.}.
...
\parser{BiLSTM} surpasses bilexical DAG parsers on the task of UCCA parsing.
