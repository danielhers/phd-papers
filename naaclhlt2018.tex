...
\multirow{2}{*}{Sparse} & \small Primary & 63.4 & 64.3 & 63.8 \\
       & \small Remote & 17 & 14.3 & 15.5 \\
\multirow{2}{*}{NN} & \small Primary & 74.5 & 74.9 & 74.7 \\
       & \small Remote & 49.2 & 50.5 & 49.8 \\
\multirow{2}{3cm}{\citet{hershcovich2017a}} & \small Primary & 74.5 & 74.9 & 74.7 \\
       & \small Remote & 49.2 & 50.5 & 49.8 \\
\hline
\textbf{UD} & \small LAS & & & \textbf{F1} \\
Sparse & & & & 64.8 \\
NN & & & & 80.1 \\
\multicolumn{4}{l}{\citet{dozat2016deep}} & 82.23 \\
\hline
...
\end{tabular}
\caption{Single-task results on the English development set for each task.
Best reported results are given for comparison.
\label{tab:single}}
\end{table}
