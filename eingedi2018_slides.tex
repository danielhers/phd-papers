...
\fbox{
Many different semantic representation schemes.
}
\end{frame}
...
%    ]
%    \addplot [fill=Navy, point meta=explicit symbolic] table [x=total,y expr=\coordindex] {\english};
%    \end{axis}
%    \end{tikzpicture}
%\end{center}
%Domains: Wikipedia, books, blogs, news, emails, reviews
%\end{frame}
