...
%   \begin{enumerate}
%     \item 
%         Structurally convert bi-lexical dependency graphs into constituency-like graphs by inserting non-terminal nodes and \textit{head} edges .
%     \item 
...
%\end{itemize}
%These rules are applied to the bi-lexical graph after the conversion process.
