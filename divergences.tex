...
\begin{abstract}
  ...
  we find that most content divergences can ascribed to three fundamental differences: 
  (1) UCCA's distinction between a Scene and a non-Scene vs. UD's POS-based distinctions;
  (2) UCCA's distinction between particiapnts and secondary relations, which is not encoded in UD; 
  ...
  To demonstrate the utility of construction-specific protocols for leverging syntax for semantic parsing,
