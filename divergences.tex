...
drawn randomly\daniel{Omri, is that correct?} from the \textit{reviews} section of the 
...
on the English \textit{Wiki} training set, using the development set for validation,
...
to parse the \textit{Wiki} and 20K test sets in English, French and German.
We use the UDPipe models trained on the English\_EWT, French\_GSD and German\_GSD
...
Table~\ref{tab:conversion_results_unlabeled} shows unlabeled evaluation of
converted gold-standard and parsed UD as compared to gold-annotated UCCA graphs.
