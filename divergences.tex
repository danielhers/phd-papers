...
\paragraph{Adverbial Clauses and Parataxis (\texttt{advcl}, \texttt{parataxis}).}
...
\paragraph{Conjunctions  (\texttt{mark}).}
...
\textit{Mode} refers to the number of occurrences of the most frequent UCCA category
