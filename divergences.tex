...
\setlength{\belowcaptionskip}{-9pt}  % adjust this to fit page limit
...
\begin{figure}[th]
  \centering
    ...
    \end{dependency}
\caption{UD tree.\label{fig:original_example_ud}}
\end{figure}
...
Non-terminals and \textit{head} edges are introduced by the unified DAG converter.\label{fig:converted_example_ud}}
\end{figure}
...
containing one Scene \cite{sulem2018samsa}.
