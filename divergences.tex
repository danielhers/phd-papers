...
we use a freely available converter between the
schemes\footnote{\url{http://github.com/huji-nlp/semstr}}
\cite{hershcovich2018multitask,hershcovich2018universal},
after extending it to assimilate the graphs by abstracting away from formalism differences.
