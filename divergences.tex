...
We annotate 804 English sentences from the reviews section of the 
...
\texttt{English\_EWT} treebank, we have both gold-standard UCCA and UD for them. 
...
\oa{I would move the confusion matrix to the next section. It's more customary to split setup and results into different sections.}
