...
The basic conversion protocol generally attaches low,
selecting for each terminal $t$ the lowest non-terminal of which $t$
is the head terminal to be its parent.\oa{is this correct?}
...
\centering
\begin{tabular}{l|ll|}
& \footnotesize \bf Primary & \footnotesize \bf Remote \\
\hline
\small \bf English EWT & 61.1 & 26.6 \\
\small \bf English Wiki & 73.3 & 47.3 \\
\small \bf English 20K & 68.2 & 23.7 \\
\small \bf French 20K & 49.6 & 2.4 \\
\small \bf German 20K & 79.6 & 59.9
\end{tabular}
\caption{
...
using both the standard primary/remote evaluation and the fine-grained evaluation by UD relations
