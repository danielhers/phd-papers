...
\begin{itemize}
\item Fused relative clauses: ``The prices were worth what I got.''
\item Different treatment of modals: ``There should only be one person bringing you your food,''
``seemed to want to help.''
\item Linkage: ``Overall, Joe is a happy camper who has found a great spot.''
\end{itemize}
...
\paragraph{appos.}
Split between Center (``its sister store Peking Garden'')
and Elaborator (``Kevin, the manager''):
