...
Cross-linguistic semantic scheme \cite{abend2013universal,abend2017the}.
Stable in translation \cite{sulem2015conceptual}.
\vfill
\begin{adjustbox}{center}
  \includegraphics[width=\pagewidth]{crosslinguistic.png}
\end{adjustbox}
\end{frame}

\begin{frame}
\frametitle{The UCCA Scheme}
Useful for machine translation evaluation \cite{birch2016hume}.
\vfill
\begin{adjustbox}{center}
  \includegraphics[width=\pagewidth]{hume.png}
\end{adjustbox}
\end{frame}
...
\begin{itemize}
 \item UCCA's semantic distinctions require a graph structure.
 \item \parser{} is a transition-based parser suitable for UCCA.
 \item Direct parsing outperforms conversion-based approach,
 	   with strong bilexical baseline parsers.
\end{itemize}
