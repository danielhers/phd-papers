...
\only<1>{
	\vfill
	\begin{flushleft}
	\hspace{2mm} Syntactic (UD)\\
	\end{flushleft}
	\vspace{-1cm}
	\begin{adjustbox}{margin=5mm,frame,center}
	\begin{dependency}
		...
		\depedge[edge below]{1}{2}{ARG2}
		\depedge[edge below,edge unit distance=1em,orange]{1}{5}{ARG1}
		\depedge[edge below]{5}{4}{ARG1}
		\depedge[edge below,orange]{6}{5}{ARG1}
		\depedge[edge below]{6}{7}{ARG2}
	\end{dependency}
	\end{adjustbox}\\
	\vspace{-1cm}
	\begin{flushright}
	Semantic (DM)\color{white}---
	\end{flushright}
