...
Representing discrete features by dense vectors \cite{goldberg2016primer}.
\vfill
\begin{adjustbox}{center}
...
\begin{frame}[fragile]
\frametitle{Feed-Forward Neural Networks (MLP)}
Learning representation and classification by optimizing weights.
\vfill
...
Applied to sequences, updating state vector.
\vfill
\begin{adjustbox}{center}
...
Memory cell to avoid vanishing gradients.
\vfill
\begin{adjustbox}{center}
	\begin{tikzpicture}[
