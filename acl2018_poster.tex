...
To check,
we (1) annotated 100 sentences from the WSJ,
and (2) compared training corpora text.
...
\begin{tikzpicture}
	    ...
	    \legend{,unigram distribution L1 distance \\ ($\times 100$; compared to UCCA Wiki),
	             remote F1 \\ (compared to gold UCCA on WSJ),
	             primary F1 \\ (compared to gold UCCA on WSJ)}
	    \end{axis}
\end{tikzpicture}
