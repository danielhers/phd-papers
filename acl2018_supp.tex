...
We also use word, tag and dependency relation dropout \cite{kiperwasser2016simple}:
...
We use $N=30$ for English, $N=100$ for French and $N=50$ for German.
...
and is publicly available at \url{http://github.com/danielhers/tupa/tree/master/scheme/conversion}.
