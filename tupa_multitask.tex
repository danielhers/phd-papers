...
scarce.\footnote{Our code is included in the supplementary material.}
...
\small Single & 62.1 & 60.9 & 61.5 & 35.7 & \enskip 9.4 & 14.9 \\
\small UD & 65.5$\star$ & 66.1$\star$ & \textbf{65.8}$\star$ & 28.6 & \enskip 7.5 & 11.9 \\
\hline
...
7\% error reduction in French, having less than 10\% the amount of training data as English,
...
(PTB WSJ).
Annotation was carried out by a single expert UCCA annotator.\footnote{Annotations are
