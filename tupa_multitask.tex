...
Next, we train it to parse UCCA in a multitask setting, where AMR, DM and UD are used as
...
For AMR, we use LDC2017T10, used in SemEval 2017
\cite{may2017semeval}.\footnote{\scriptsize\url{https://catalog.ldc.upenn.edu/LDC2017T10}}
For SDP, we use data for the DM target representation from the SDP 2016 dataset
