...
%multitask is good for small data and cross-domain \cite{Rush2012ImprovedPA,Finkel2009JointPA}
...
as scaffolding.
\citet{E17-1005} showed that multitask learning works best when auxiliary tasks have few labels
...
The limited capacity forces the network to utilize the shared parameters for all tasks,
...
Previous work has shown that multitask learning works best when auxiliary tasks are annotated
