...
Transition-based parsing was first used for projective syntactic dependency tree parsing
\cite{nivre2008algorithms}.
Subsequent works generalized the framework to non-projective and (discontinuous) constituency
parsing \cite{nivre2009non,zhang2009transition,maier-lichte:2016:DiscoNLP}.
Previous works on transition-based Semantic Dependency Parsing and UCCA parsing
