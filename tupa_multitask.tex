...
and semantic parsing across domains and languages
...
Many efforts have been dedicated to sharing parameters across higher-level tasks, such as
joint syntactic and semantic dependency parsing---including
...
showing some improvement by sharing parameters across highly overlapping, parallel-annotated
...
Domain adaptation, concerned with generalization across domains for the same task,
is also enabled by parameter sharing \cite{W06-1615,P07-1033,K17-1040}.
...
Existing AMR parsers take one of several approaches.
...
A recent approach is based on the sequence-to-sequence model \cite{sutskever2014sequence},
...
Our transition-based approach, on the other hand,
handles AMR using the same general DAG parser used for other schemes.
