...
%MTL is good for small data and cross-domain \cite{Rush2012ImprovedPA,Finkel2009JointPA}
%difference between domains \cite{Plank2011EffectiveMO,E17-1005}
...
Supplementary Material for more details about the conversion.}.
...
\hline
\multicolumn{4}{l|}{\small \bf Germa (in-domain)n} & \\
\small Single & 73.7 & 72.4 & 73.1 & 49.2 & 12.3 & 19.7 \\
\small UD & 74.6$\star$ & 73.7$\star$ & 74.2$\star$ & 61.7$\star$ & 20.6$\star$ & 30.9$\star$
\end{tabular}
\caption{
...
while the other models use the specified unlabeled auxiliary tasks in the same language.
}
...
$\star$~indicates statistical significance ($p<0.05$)
when compared to single-task results, by the bootstrap test.
}
