...
Since the training sets differ in size, we sample the same number of sentences from
the training set of each task---the number of sentences in the UCCA training set.
...
we perform unlabeled evaluation (like labeled evaluation, but ignoring edge labels)
of a manually annotated sample of 100 sentences from the
