...
\hline
\textbf{SDP} & SemEval 2015 \small(DM) & 802717 & 35657 \\
\end{tabular}
...
\textbf{UCCA Wiki} & & \textbf{LP} & \textbf{LR} & \textbf{LF} \\
\multirow{2}{*}{Ours} &
...
\hline
\textbf{SDP (DM)} & & \textbf{LP} & \textbf{LR} & \textbf{LF} \\
Ours & & 76 & 75.4 & 75.7 \\
...
(the classifier does not get even a single edge right on the tiny French dataset),
when coupled with UD parsing as an auxiliary task, the classifier surpasses it
in both languages.
