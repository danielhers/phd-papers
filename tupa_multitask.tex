...
\daniel{Mention shared task, mention that results using joint learning is not as good as pipeline
...
notably in the SemEval 2017 shared task \cite{may2017semeval}.\daniel{Omri, you said
"say more about AMR parsing,
e.g., what apperoaches people have taken, and that parsers are taylored for it and why" -
I definitely should, but I mentioned some of it in Related Work. Let's discuss what goes here
and what there.}
...
available at \url{https://github.com/huji-nlp/ucca-corpus}}
