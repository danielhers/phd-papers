...
language understanding tasks \cite{P16-1139,dozat2016deep,E17-1117}.
...
Semantic schemes diverge the content they choose to annotate, their coupling with syntax,
...
Semantic Dependencies \cite[SDP;][]{oepen2014semeval,oepen2015semeval,oepen2016towards,P17-1186}, and
Universal Conceptual Cognitive Annotation \cite[UCCA;][]{abend2013universal,hershcovich2017a}.

These tasks require parsers that can handle a general directed acyclic graph (DAG) structure.
...
Pre-terminal nodes are omitted for brevity, i.e., each terminal is drawn in place of its parent.}
...
we propose an algorithm to convert them all into a unified DAG format.
