...
\hline
\footnotesize Dimensions &  \footnotesize single & \footnotesize main & \footnotesize aux & \footnotesize shared \\
\hline
...
of three models trained with different random seeds. The transition selected is
\[
...
Following previous work, we use the same hyperparameter settings as for the single-task case
...
we use a shared BiLSTM, whose number of layers and dimensions are the same as .
...
\cite{may2017semeval}.\footnote{\scriptsize\url{https://catalog.ldc.upenn.edu/LDC2017T10}}
