...
\centering
	\begin{tabular}{l|ccc|ccc||ccc|ccc}
		...
		\hline
		\multicolumn{2}{l}{\small Ours (multitask)} \\
		...
		DM+UD & 73.7 & 73.5 & 73.6 & 43.5 & 42.4 & 42.9 \\
		AMR+DM+UD & 72.6 & 74.9 & 73.7 & 49.8 & 46.4 & 48.1 \\
		\multicolumn{2}{l}{\small Ours (multitask ensemble)} \\
	\end{tabular}
	\caption{
...
in a single-task and multitask setting, where as an auxiliary task we use the UD treebanks
in the respective languages.\footnote{We did not use AMR, DM or enhanced UD in French and German,
as these are only available in English.}
