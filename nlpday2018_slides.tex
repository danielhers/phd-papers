...
\begin{tikzpicture}
	    ...
	    reverse legend,
        legend style={at={(axis cs:35,4)},anchor=south west},
	    axis x line=none,
	    clip=false
	    ]
...
\begin{tikzpicture}
	    ...
	    reverse legend,
        legend style={at={(axis cs:2,4)},anchor=south west},
	    axis x line=none,
	    clip=false
	    ]
	    \addplot [fill=Crimson, point meta=explicit symbolic,nodes near coords,
...
\begin{tikzpicture}
	    ...
	    reverse legend,
        legend style={at={(axis cs:-10,.2)},anchor=south west},
	    axis x line=none,
	    clip=false
	    ]
	    \addplot [fill=Crimson, point meta=explicit symbolic,nodes near coords,
...
\vfill
\only<2>{\scalebox{.5}}{\begin{tikzpicture}
	    \begin{axis}[
	    xbar,
	    width=9cm,
	    height=45mm,
	    ...
	    \legend{in-domain primary F1,in-domain remote F1}
	    \end{axis}
\end{tikzpicture}}
\end{frame}
...
\begin{tikzpicture}
	    ...
	    \addplot [fill=Navy, point meta=explicit symbolic,nodes near coords,
	    nodes near coords align={anchor=west}] table [x=pf1,y expr=\coordindex,meta=pf1] {\similaritydata};
	    \legend{in-domain primary F1,in-domain remote F1,conversion primary F1,conversion remote F1,unigram L1 distance}
	    \end{axis}
\end{tikzpicture}
\end{frame}
