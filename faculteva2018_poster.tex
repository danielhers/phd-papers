...
\begin{center}
   ...
   \draw[color=gray,dashed] (0,-.8) rectangle (34,3.6);
   \draw[color=gray] (3,0) rectangle (8,1.5);
   \node[fill=cyan, circle] at (4,.75) {};
   \node[fill=orange, circle] at (5.5,.75) {};
   \node[anchor=west] at (6.2,.5) {,};
   \node[anchor=west] at (9,.5) {Buffer:};
   \draw[color=gray] (12.5,0) rectangle (22,1.5);
...
Implemented using DyNet: \url{http://github.com/clab/dynet} \vspace{-1cm}}
