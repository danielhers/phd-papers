...
the results obtained with the SVM classifier, which are about 1\% F-score higher.
%different transition systems and local classifiers.
As the different
...
The quality of the results is emphasized by UCCA's inter-annotator agreement on primary edges (often
taken as an upper bound), of a little over 80\% F-score \cite{abend2013universal}.
