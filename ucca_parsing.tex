...
applying the parsing approaches both to in-domain and out-of-domain scenarios,
and obtain results comparable to the state-of-the-art in other broad-coverage
semantic parsing tasks.
The best performing parser obtains a labeled F-score of nearly 70\%.
