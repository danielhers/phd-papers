...
\begin{abstract}
  ...
  % (representations supporting these properties are called
  % {\it Broad-coverage Semantic Structures}, % or BSS).
  We propose
  ...
  structural semantic properties, and obtain encouraging results.
