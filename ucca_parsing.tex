...
has an incoming primary edge\oa{is that correct?}.
...
with a beam size of 4, where the other parsers use greedy search.\oa{is that true
  for LSTM too?}
...
MALT_{arc-std} &  &  &  & $-$ & 0 & 0 \\
MALT_{arc-eager} & 61.1 & 56.5 & 58.7 & $-$ & 0 & 0 \\
...
\oa{Consider including paragraph-level parsing results, and results on \textsc{BCS}
  applied to the converted broad-coverage semantic dependencies dataset.}.
