...
This parser combines techniques from transition-based discontiguous constituency parsing \cite{maier2015discontinuous}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Related Semantic and Syntactic Parsing Work.}\label{sec:related}
