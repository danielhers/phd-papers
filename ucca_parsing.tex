...
\begin{abstract}
  ...
  We experiment with the UCCA corpora, the only ones with all structural semantic properties, and obtain encouraging results.
...
UCCA structures support all three criteria of BSS: multiple parents, non-terminal nodes, and discontinuous units.
