...
The second is \textbf{non-terminal nodes}, in order to represent units
...
The many ad-hoc solutions to this problem suffer from lack of standardization \cite{Ivanova2012who}
and task-dependence: representing the preposition as the head of a prepositional phrase, for example,
yields better results for parsing \cite{Schwartz:12}, although the nominal phrase is more meaningful
e.g. for information extraction. \daniel{to review}
...
This is a common phenomenon with other multi-word expressions, too \cite{schneider2014discriminative}.
\daniel{to review}
...
it had a positive contribution on the prediction of remote edges.
The \textbf{unigrams} and \textbf{bigrams} features are especially
...
which is likely to be amplified in languages
with a higher percentage of discontinuous units, such as German.
