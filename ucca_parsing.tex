...
where $p$ is the parent, and $c$ is the child, define $yield(e) \subset W$ as the
set of terminals in $W$ which are descendants of $c$. We define:
...
Precision and Recall are defined by dividing $M(G_P,G_G)$ with $|E_P|$ and $|E_G|$ respectively.
