...
edges\footnote{As for trees, labeling nodes is equivalent to labeling edges,
  we do not distinguish between the two options. 
  Note also that as the original structures may contain discontiguities, the resulting trees may too.}.
