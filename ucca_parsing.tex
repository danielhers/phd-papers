...
\paragraph{\textsc{bsp}.}
We train \textsc{bsp} for 16 iterations, using $\textsc{MinUpdate}=5$ and a constant learning rate of 1.
We use $\textsc{Importance}=2$, doubling the weight updates
...
to allow more direct comparison with conversion-based methods that can only
predict trees.
