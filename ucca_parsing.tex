...
For our parser, we use a \textsc{MinUpdate} of 5.
We omit linkage edges and nodes, as these are not handled by the evaluation metrics yet and are not an essential part of the semantic parsing scheme. We also omit implicit nodes, leaving them for future work.
