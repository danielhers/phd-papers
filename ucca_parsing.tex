...
& Wiki & o-o-d \\
\hline
\multicolumn{3}{l}{\textbf{Over whole corpus:}} \\
...
\multicolumn{3}{l}{\textbf{Average over non-terminals:}} \\
\# parents & 1.07 & 1.07 \\
\# children & 1.7 & 1.63 \\
\end{tabular}
...
\tabref{table:convert} shows the precision, recall and F1 scores of the different methods.
\begin{table*}
\begin{tabular}{lccc}
\textbf{Method} & \textbf{LP} & \textbf{LR} & \textbf{LF} \\
\hline
\multicolumn{4}{l}{\textbf{Constituency format}} \\
Oracle & & & \\
\textsc{uparse} & & & \\
\hline
\multicolumn{4}{l}{\textbf{Constituency format}} \\
...
LSTM Parser & & & \\
\hline
\multicolumn{4}{l}{\textbf{Direct approach}} \\
UCCA Parser & & & \\
UCCA Parser (o-o-d) & & & \\
\end{tabular}
%\begin{adjustbox}{width=\textwidth}
