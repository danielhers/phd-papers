...
Our parser mostly builds on recent advances in the dependency discontiguous constituency
and DAG parsing techniques, and further introduces novel UCCA-oriented features for parsing BSS.
...
we perform feature ablation experiments on the \textsc{bsp},
...
design better semantic represnetations.
We believe that UCCA's merits in providing a cross-linguistically applicable, broad-coverage
annotation is likely to support ongoing efforts to incorporate deeper semantic structures
