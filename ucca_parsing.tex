...
The \textbf{unigrams} and \textbf{bigrams} features are especially important, and the \textbf{ratio} feature greatly improves recall on primary edges.
The \textbf{disco} features had a moderate contribution, and we expect them to be even more beneficial in languages with a high percentage of discontiguous units, such as German.
...
\caption{
  Results in percents for the feature ablation experiment (on the \textit{Wiki} development set).
