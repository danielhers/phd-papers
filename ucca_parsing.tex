...
on parsing, as it requries that the alignment between words and logical symbols be automatically
...
to constituency parsing \cite{sagae2005classifier,zhang2009transition,zhu2013fast}, and has been recently extended to
...
Our parser combines techniques from transition-based discontiguous constituency parsing \cite{maier2015discontinuous}
