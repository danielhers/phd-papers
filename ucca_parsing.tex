...
\textbf{\tiny Stack} & \textbf{\tiny Buffer} & \textbf{\tiny Nodes} & \multicolumn{1}{l}{\textbf{\tiny Edges}} & \multicolumn{1}{c|}{\textbf{\tiny Terminal?}} & \textbf{\tiny Stack} & \textbf{\tiny Buffer} & \textbf{\tiny Nodes} & \textbf{\tiny Edges} & \multicolumn{1}{c}{\textbf{\tiny Terminal?}} \\
...
\textbf{\tiny Stack} & \textbf{\tiny Buffer} & \textbf{\tiny Nodes} & \textbf{\tiny Edges} & & \textbf{\tiny Stack} & \textbf{\tiny Buffer} & \textbf{\tiny Nodes} & \textbf{\tiny Edges} & \textbf{\tiny Terminal?} & \\
...
Features on the left are from Zhu~\shortcite{zhu2013fast}.
Discontinuous features are from Maier~\shortcite{maier2015discontinuous}.
Counts, existing edges and past actions features are from \cite{tokgoz2015transition}.
}
\end{figure*}
