...
yielding DAG (directed acyclic graph), rather than tree structures. This has motivated much recent
...
\caption{\label{fig:ucca_example1}
  ...
  The first sentence demonstrates a linkage relation, and the second sentence exhibits a discontinuous unit (``take a shower'').
