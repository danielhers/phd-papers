...
\end{dependency}
\end{minipage}
\begin{minipage}{.2\columnwidth}\begin{tikzpicture}[->,level distance=1cm,
  ...
  \node (1_1) [circle] {}
  {
  child {node (1_2) [word] {But}  edge from parent node[auto]  {\scriptsize $L$}}
  child {node (1_3) [circle] {}
    {
    child {node (1_5) [word] {\textbf{IMPLICIT}}  edge from parent node[auto]  {\scriptsize $A$}}
    child {node (1_6) [word] {service}  edge from parent node[auto]  {\scriptsize $P$}}
    child {node (1_7) [word] {is}  edge from parent node[auto]  {\scriptsize $F$}}
    child {node (1_8) [circle] {}
      {
      child {node (1_9) [word] {very}  edge from parent node[auto]  {\scriptsize $E$}}
      child {node (1_10) [word] {poor}  edge from parent node[auto]  {\scriptsize $C$}}
      child {node (1_11) [word] {.}  edge from parent node[auto]  {\scriptsize $U$}}
      } edge from parent node[auto]  {\scriptsize $D$}}
