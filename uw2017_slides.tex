    ...
    \node (ROOT) [fill=blue, circle] {}
      ...
      child {node (totakealongbath) [fill=blue, circle] {}
      {
        ...
        child {node (takeabath) [fill=blue, circle] {}
        {
          ...
          child {node [word] (long) {long} edge from parent[white]}
...
\begin{center}
  \begin{tikzpicture}[level distance=15mm, ->,
    ...
    \node (ROOT) [draw=black,ellipse] {move-01}
      ...
      child {node (Joe) [draw=black,ellipse] {person}
      {
      	child {node {}
	    {
	    ...
	    {
		    child {node [draw=black,ellipse] {"Joe"}
		    {
		      child {node [word] {Joe} edge from parent}
		    } edge from parent node {op1} }
      ...
      child {node [draw=black,ellipse] {city}
      {
        ...
        child {node [draw=black,ellipse] {name}
	    {
		    child {node [draw=black,ellipse] {"Paris"}
		    {
      ...
      \draw[dashed] (graduation) to node {ARG0} (Joe);
  \end{tikzpicture}
...
\begin{frame}
\frametitle{Future Work: SDP}
Should be possible, since:
\begin{itemize}
	\item Bilexical approximation can be applied in reverse.
	\item \parser{} is a general DAG parser.
\end{itemize}
\begin{center}
  \begin{tikzpicture}[level distance=18mm, ->,
    ...
    \node (ROOT) [fill=black,circle] {}
      ...
      child {node (moved) [fill=black,circle] {}
      {
        child {node [word] {Joe} edge from parent node {ARG1}}
        child {node [word] {moved} edge from parent}
