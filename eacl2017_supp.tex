...
Converting the sentence in Figure 1a results in the tree given in \figref{fig:con_example}.
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[level distance=10mm, ->]
    \node (ROOT) [fill=black, circle] {}
      ...
      ;
  \end{tikzpicture}
  \caption{Tree approximation for the UCCA graph in Figure 1a from the paper}
...
\depedge{5}{7}{A}
\end{dependency}
  \caption{Bilexical tree approximation for the UCCA graph in Figure 1a from the paper}
